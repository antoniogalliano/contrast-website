...
function Tag({ label }: { label: string }) {
  return (
    <span style={{ fontSize: 12, fontWeight: 500, color: "rgba(255,255,255,0.55)", padding: "5px 14px", borderRadius: 100, border: "1px solid rgba(56,56,56,0.9)", fontFamily: "var(--font-urbanist), sans-serif", whiteSpace: "nowrap" }}>{label}</span>
  );
}
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 28 }}>
              <Tag label="B2B / Retail Tech" />
              <Tag label="Product Design" />
              <Tag label="Web Design & Development" />
            </div>
            <h1 style={{ fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 700, fontSize: "clamp(48px, 5.5vw, 84px)", lineHeight: 1.0, letterSpacing: "-0.03em", color: "#ffffff", margin: "0 0 28px" }}>Cymbio</h1>
          ...
          >
            <div style={{ width: "143%", borderRadius: "20px 0 0 20px", overflow: "hidden", border: "1px solid rgba(56,56,56,0.6)", borderRight: "none" }}>
              <img src="/work/cymbio.png" alt="Cymbio dashboard" style={{ width: "100%", height: 640, objectFit: "cover", objectPosition: "top center", display: "block" }} />
            </div>
          </motion.div>
        </div>
        <style jsx global>{`
        ...
        <div style={{ maxWidth: 1360, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, paddingTop: 64, alignItems: "start" }} className="case-overview-grid">
            <motion.div {...fadeUp(0)}>
              ...
              <h2 style={{ fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 600, fontSize: "clamp(28px, 3vw, 42px)", lineHeight: 1.15, letterSpacing: "-0.01em", color: "#ffffff", margin: "0 0 28px" }}>Bringing clarity to complex multi-channel retail data</h2>
            ...
            <motion.div {...fadeUp(0.1)} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0, border: "1px solid rgba(56,56,56,0.7)", borderRadius: 16, overflow: "hidden" }}>
              {[{ label: "Client", value: "Cymbio" }, { label: "Industry", value: "B2B / Retail Tech" }, { label: "Year", value: "2024" }, { label: "Duration", value: "5 months" }, { label: "Our Role", value: "Product Design" }, { label: "Type", value: "SaaS Dashboard" }].map((item, i) => (
        ...
        <div style={{ maxWidth: 1360, margin: "0 auto" }}>
          ...
          <div style={{ paddingTop: 64, display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 16 }} className="case-img-grid">
            <motion.div {...fadeUp(0)} style={{ borderRadius: 16, overflow: "hidden", border: "1px solid rgba(56,56,56,0.6)" }}>
              <img src="/work/cymbio.png" alt="Cymbio sales overview" style={{ width: "100%", height: 480, objectFit: "cover", objectPosition: "top left", display: "block" }} />
            </motion.div>
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <motion.div {...fadeUp(0.08)} style={{ borderRadius: 16, overflow: "hidden", border: "1px solid rgba(56,56,56,0.6)", flex: 1 }}>
                <img src="/work/cymbio.png" alt="Cymbio CymAI" style={{ width: "100%", height: 232, objectFit: "cover", objectPosition: "right center", display: "block" }} />
              </motion.div>
              <motion.div {...fadeUp(0.14)} style={{ borderRadius: 16, overflow: "hidden", border: "1px solid rgba(56,56,56,0.6)", flex: 1 }}>
                <img src="/work/cymbio.png" alt="Cymbio chart" style={{ width: "100%", height: 232, objectFit: "cover", objectPosition: "bottom center", display: "block" }} />
              </motion.div>
            </div>
          </div>
        </div>
        ...
        <div style={{ maxWidth: 1360, margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ paddingTop: 64 }}>
            ...
            <motion.h2 {...fadeUp(0.05)} style={{ fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 600, fontSize: "clamp(32px, 4.5vw, 60px)", lineHeight: 1.12, letterSpacing: "-0.02em", color: "#ffffff", margin: "0 0 40px", maxWidth: 900 }}>
              Sales teams were swimming in data — but couldn&apos;t see what mattered.
            </motion.h2>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16 }} className="case-problem-grid">
              {[
                { number: "01", title: "Data Fragmentation", desc: "Performance data was spread across Farfetch, Macy's, Zalando, and 30+ other channels. Getting a consolidated view required manual exports and spreadsheet gymnastics." },
                { number: "02", title: "No Actionable Insight", desc: "Raw data was available — but interpretation wasn't. Teams couldn't quickly identify which channels were underperforming or why top SKUs were declining." },
                { number: "03", title: "Slow Decision Cycles", desc: "Without real-time visibility and clear alerts, decisions on stock allocation, pricing, and promotions were made too late — costing revenue and relationships." },
              ].map((item, i) => (
        ...
        <div style={{ maxWidth: 1360, margin: "0 auto" }}>
          ...
          <div style={{ paddingTop: 64, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }} className="case-exploration-grid">
            <motion.div {...fadeUp(0)}>
              ...
              <h2 style={{ fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 600, fontSize: "clamp(28px, 3vw, 42px)", lineHeight: 1.15, letterSpacing: "-0.01em", color: "#ffffff", margin: "0 0 28px" }}>Understanding the jobs-to-be-done for B2B sales teams</h2>
              <p style={{ fontFamily: "var(--font-geist), sans-serif", fontWeight: 300, fontSize: 16, lineHeight: 1.75, color: "rgba(255,255,255,0.6)", margin: "0 0 20px" }}>
                We ran deep stakeholder interviews with Cymbio&apos;s enterprise clients — brand managers, sales directors, and account executives at companies like CROPP — to understand how decisions were actually being made in the field.
              </p>
              <p style={{ fontFamily: "var(--font-geist), sans-serif", fontWeight: 300, fontSize: 16, lineHeight: 1.75, color: "rgba(255,255,255,0.6)", margin: 0 }}>
                We mapped current workflows, identified the highest-value reporting jobs, and audited 14 competing analytics tools to establish a clear design direction.
              </p>
            </motion.div>
            <motion.div {...fadeUp(0.1)} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                "Sales directors spent an average of 3.2 hours per week manually reconciling channel data — time that was almost universally described as \"the worst part of the job\".",
                "The most critical metric varied by role: brand managers cared about sell-through rates, while sales directors prioritised AOV and channel growth YoY.",
                "Users trusted AI-generated summaries for high-level questions — but wanted to verify the underlying data themselves before acting on recommendations.",
                "93% of interviewed users said they&apos;d pay more for a tool that could tell them \"what to do next\" — not just show them what had happened.",
              ].map((insight, i) => (
                <MouseFollowCard key={i} delay={0.05 + i * 0.07} padding="20px 24px">
                  <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                    ...
                    <p style={{ fontFamily: "var(--font-geist), sans-serif", fontWeight: 300, fontSize: 14, lineHeight: 1.7, color: "rgba(255,255,255,0.7)", margin: 0 }} dangerouslySetInnerHTML={{ __html: insight }} />
                  </div>
                </MouseFollowCard>
              ))}
            </motion.div>
          ...
          <div style={{ paddingTop: 64 }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 80, alignItems: "start" }} className="case-whatwedid-grid">
              <motion.div {...fadeUp(0)}>
                ...
                <h2 style={{ fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 600, fontSize: "clamp(28px, 3vw, 42px)", lineHeight: 1.15, letterSpacing: "-0.01em", color: "#ffffff", margin: 0 }}>From data overload to decision-ready clarity</h2>
              </motion.div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0, border: "1px solid rgba(56,56,56,0.7)", borderRadius: 16, overflow: "hidden" }} className="case-deliverables-grid">
                {[
                  { num: "01", title: "Dashboard Architecture", desc: "Redesigned the information architecture so that the most critical KPIs — total sales, net revenue, AOV, cancellations — are visible at a glance, with clear trend indicators." },
                  { num: "02", title: "CymAI Integration", desc: "Designed a natural-language AI assistant that lets users ask questions like \"Show me Farfetch sales for Q1\" and get an instant structured summary with citations." },
                  { num: "03", title: "Channel Analytics", desc: "Built a multi-channel breakdown view with stackable bar charts, sortable tables, and a per-channel time-series — so teams can drill from macro to micro in seconds." },
                  { num: "04", title: "Design System", desc: "Created a comprehensive component library covering tables, charts, filters, alerts, and empty states — giving Cymbio's engineering team a scalable UI foundation." },
                  { num: "05", title: "Data Visualisation", desc: "Defined a chart language for the platform — including colour encoding for channels, axis conventions, and responsive behaviour — making dense data immediately readable." },
                  { num: "06", title: "Dev Handoff", desc: "Delivered annotated specs, interactive prototypes, and a full Figma component library — reducing design-to-dev friction and enabling a faster engineering sprint." },
                ].map((item, i) => (
      ...
      <section style={{ padding: "100px 40px" }}>
        <div style={{ maxWidth: 1360, margin: "0 auto" }}>
          ...
          <motion.div {...fadeUp(0)} style={{ paddingTop: 64, marginBottom: 64 }}>
            ...
            <h2 style={{ fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 600, fontSize: "clamp(28px, 3vw, 42px)", lineHeight: 1.15, letterSpacing: "-0.01em", color: "#ffffff", margin: 0, maxWidth: 600 }}>Clarity as a competitive advantage</h2>
          </motion.div>
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {[
              { title: "A dashboard built around decisions, not data", desc: "We flipped the traditional analytics model — instead of showing everything and letting users figure it out, the Cymbio dashboard surfaces the metrics that matter most to each role upfront. The result: critical KPIs visible in under 3 seconds, with clear delta indicators and contextual benchmarks.", imagePos: "top left", reverse: false },
              { title: "CymAI — your data analyst, always on", desc: "We designed CymAI as a persistent side panel — not a modal or a chatbot overlay. Users can ask natural-language questions about any metric, get structured summaries with source citations, and drill into the underlying data without losing context. It bridges the gap between raw analytics and actionable direction.", imagePos: "right center", reverse: true },
              { title: "A chart language that scales across the platform", desc: "We defined a unified data visualisation system — consistent axis conventions, channel colour encoding, chart type selection rules, and responsive breakpoints — so that every chart in the product feels like part of the same language. Dense data, made readable.", imagePos: "bottom center", reverse: false },
            ].map((block, i) => (
              <motion.div key={i} {...fadeUp(0)} style={{ display: "grid", gridTemplateColumns: block.reverse ? "1fr 1.3fr" : "1.3fr 1fr", gap: 0, borderRadius: 20, border: "1px solid rgba(56,56,56,0.6)", overflow: "hidden", background: "rgba(255,255,255,0.015)", minHeight: 380 }} className="case-block-row">
                <div style={{ order: block.reverse ? 1 : 0, overflow: "hidden", borderRight: block.reverse ? "none" : "1px solid rgba(56,56,56,0.6)", borderLeft: block.reverse ? "1px solid rgba(56,56,56,0.6)" : "none" }}>
                  <img src="/work/cymbio.png" alt={block.title} style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: block.imagePos, display: "block" }} />
                </div>
        ...
        <div style={{ maxWidth: 1360, margin: "0 auto" }}>
          ...
          <div style={{ paddingTop: 64 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }} className="case-more-grid">
              <CaseCard client="Designrr" title="Engagement & Retention Overhaul" tags={["Web Design & Development"]} image="/work/designrr.png" href="/work/designrr" delay={0} />
              <CaseCard client="JUSTT" title="Chargeback Management SaaS" tags={["Web Design & Development"]} image="/work/justt.png" href="/work/justt" delay={0.1} />
            </div>
          </div>
        </div>
