...
// ── Calendar ───────────────────────────────────────────────────────────────
function Calendar({ onBook }: { onBook: () => void }) {
  const now = new Date();
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16, width: "100%" }}>
      ...
      {/* Book button — appears when a date is selected */}
      <AnimatePresence>
        {selected !== null && (
          <motion.button
    ...
    >
      ...
      >
        ...
        <button
          ...
          onMouseEnter={e => (e.currentTarget.style.background = "rgba(217,12,183,0.15)")}
...
export default function ContactSection() {
  ...
  return (
    <>
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{ position: "absolute", bottom: 23, right: 24, fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 400, fontSize: 14, color: "rgba(255,255,255,0.6)", whiteSpace: "nowrap", lineHeight: 1.5, cursor: "pointer" }}
              >
                Open full scheduler ↗
              </span>
              ...
              <div style={{ position: "absolute", left: 424, top: 23, width: 351, display: "flex", flexDirection: "column", gap: 32, alignItems: "flex-start" }}>
                ...
                <Calendar onBook={() => setShowOverlay(true)} />
      ...
      {/* ── Motion overlay ── */}
      <AnimatePresence>
        {showOverlay && <BookingOverlay onClose={() => setShowOverlay(false)} />}
      </AnimatePresence>
    </>
  );
}
