    ...
    <section id="contact" style={{ padding: "120px 40px 300px", background: "#0a0a0a" }}>
      <div style={{ maxWidth: 1360, margin: "0 auto", display: "flex", justifyContent: "center" }}>
        <motion.div
          ...
          style={{ position: "relative", width: 900, display: "flex", flexDirection: "column", gap: 55, alignItems: "center" }}
        >
          {/* ── Background glows ── */}
          ...
          >
            ...
            <div
              style={{
                ...
                borderRight: "1px solid rgba(56,56,56,0.8)",
              }}
            >
              <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                {/* Title */}
                <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  <span style={{ fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 700, fontSize: 15, color: "rgba(255,255,255,0.5)", lineHeight: 1.5 }}>
                    Contrast Studio
                  </span>
                  <span style={{ fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 700, fontSize: 24, color: "#ffffff", lineHeight: 1.3 }}>
                    UX Growth Strategy
                  </span>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <img src="/contact/clock.svg" alt="" aria-hidden="true" style={{ width: 18, height: 18, opacity: 0.7 }} />
                    <span style={{ fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 600, fontSize: 15, color: "rgba(255,255,255,0.6)", lineHeight: 1.5 }}>30 min</span>
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <img src="/contact/phone.svg" alt="" aria-hidden="true" style={{ width: 18, height: 18, opacity: 0.7 }} />
                    <span style={{ fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 600, fontSize: 15, color: "rgba(255,255,255,0.6)", lineHeight: 1.5 }}>Video call</span>
                  </div>
                </div>

                {/* Divider */}
                <div style={{ height: 1, background: "rgba(56,56,56,0.8)", width: "100%" }} />

                {/* Description */}
                <p style={{ margin: 0, fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 400, fontSize: 14, color: "rgba(255,255,255,0.7)", lineHeight: 1.6 }}>
              ...
              {/* Bottom links */}
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", fontFamily: "var(--font-urbanist), sans-serif", fontWeight: 400, fontSize: 13, whiteSpace: "nowrap", paddingTop: 16 }}>
                <span style={{ color: "#d90cb7", lineHeight: 1.5, cursor: "pointer" }}>Cookie settings</span>
                <span style={{ color: "rgba(255,255,255,0.4)", lineHeight: 1.5, cursor: "pointer" }}>Report abuse</span>
              </div>
            </div>

            {/* ── RIGHT PANEL — Motion scheduler ── */}
            <div style={{ flex: 1, position: "relative", minHeight: 660 }}>
              <iframe
                src={MOTION_URL}
